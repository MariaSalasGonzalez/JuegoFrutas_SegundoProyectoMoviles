...
public class MainActivity2Nivel7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 7 - Multiplicaciones Avanzadas", Toast.LENGTH_SHORT).show();
    ...
    public void numeroAleatorio() {
        ...
        if(score <= 69){
            ...
            Intent intent = new Intent(this, MainActivity2Nivel8.class);
