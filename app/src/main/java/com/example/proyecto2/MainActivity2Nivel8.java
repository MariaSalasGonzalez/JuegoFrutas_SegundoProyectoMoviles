...
public class MainActivity2Nivel8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 8 - Divisiones Básicas", Toast.LENGTH_SHORT).show();
    ...
    public void numeroAleatorio() {
        try {
            if (score <= 79) {
                ...
                if (numAleatorio_uno >= numAleatorio_dos && (numAleatorio_uno % numAleatorio_dos) == 0) {
                ...
                Intent intent = new Intent(this, MainActivity2GanaJuego.class);
