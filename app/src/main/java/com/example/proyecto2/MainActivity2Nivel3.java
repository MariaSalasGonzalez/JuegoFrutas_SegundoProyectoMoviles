...
public class MainActivity2Nivel3 extends AppCompatActivity {
    TextView tv_nombre, tv_score;
    ImageView iv_imgUno, iv_imgDos, iv_vidas;
    ...
    public void numeroAleatorio() {
        if(score <= 29){
            ...
            Intent intent = new Intent(this, MainActivity2Nivel4.class);
